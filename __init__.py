...
def get_date():
    ...
    date_font2 = ImageFont.truetype("./plugins/bot_moyu/font/sourceserif4subhead-bold.ttf", 60)  # 日期字体：Source Serif 4 Subhead Bold，60
    ...
    draw.text((279, 233), random.choice(arr1).replace("$1", "周"+get_week_day(datetime.datetime.now())), colour, font=date_font3)   # 宣言
